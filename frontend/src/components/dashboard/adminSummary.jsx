  ...
  return (
    <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <SummaryCard icon={<FaBuilding />} text="Total Departments" number={5} color="bg-teal-600"/>
            <SummaryCard icon={<FaMoneyBillWave />} text="Monthly Sallary" number="$654" color="bg-red-600"/>
        </div>
